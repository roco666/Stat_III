...
\item  Calculez la statistique de test sur le coefficient de corrélation, pour savoir s'il existe une corrélation linéaire positive entre l'attitude et la durée.
...
%		%\medskip
%		%De plus, si $\bar{X}$ est donné, l'estimateur par régression de 
%		%$\bar{Y}$ est $\bar{y}_{\reg} = a + b\bar{X} = 1.0793 + 0.5897\cdot\bar{X}$.
%
