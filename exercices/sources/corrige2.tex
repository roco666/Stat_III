...
Soit $Y$ le nombre de personnes qui assistent à la représentation d'une pièce de théâtre.
 ...
 \item Pour 5 jours de représentation pris au hasard on a observé:
	 ...
	 \end{array}
	 $$
	 Estimer l'espérance $E(Y) = \mu $ par la médiane de l'échantillon 	 $\bar{y}$, puis par la moyenne de l'échantillon $\bar{y}$.
	 $$\bar{y}=\frac{1475}{5}=295\quad \tilde y = 295$$
 \item Pour 4 nouveaux jours choisis au hasard on a observé :
	 ...
	 $$\tilde y = 295\quad\bar{y}=\frac{2668}{9}\approx 296.4$$
 ...
 \item Pour les cinq premières observations on trouve:
	...
	non-biaisée de l'écart type de $\bar{y}$ dans chacun des deux cas considérés.
	Commenter.
 ...
 \item Supposons maintenant qu'à la suite d'une erreur le nombre d'entrées du 9ème jour ait été mal relevé. De ce fait nous avons:
   ...
   $$\tilde y = 295\quad \bar{y}=\frac{2416}{9}\approx 268.4$$
   La médiane est ici plus pertinente que la moyenne comme estimateur de $\mu$ car elle est plus robuste.	 
 \end{enumerate}
