...
\begin{itemize}
	\item Savoir interpréter des résultats de tests statistiques utilisant la méthode de la $p$-valeur
...
\begin{tabular}{cl}
	...
	$p$       & = proportion supposée de la population étudiée\\
...
\begin{slide}[toc=output]{Interprétation}
\begin{itemize}
	...
	\item Degré de confiance? \pause $p=0.99$\pause
...
La $p$-valeur est le double de cette probabilité.
\end{slide}
...
\begin{itemize}
  ...
  \item[4. ] Région critique \pause $p$-valeur < $\alpha$\pause
...
\end{eqnarray*}
$r_{1,\bar{x}} \leq \overline{x}=27 \leq r_{2,\bar{x}} \Rightarrow$ $H_0$ n'est pas rejetée.
\end{slide}
